...
export const registrationUser = CatchAsycError(
...
export const socialAuth = CatchAsycError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const updateUserInfo = CatchAsycError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const updatepassword = CatchAsycError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const updateProfilePicture = CatchAsycError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
